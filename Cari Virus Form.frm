...
Private Sub cmdCari_Click()
    ...
    Dim JmlFile As Integer, JmlDir As Integer, JmlCuriga As Integer
    ...
    Cari_Virus DriveYgDicari, FileYgDicari, JmlFile, JmlDir, JmlCuriga
    
    Me.MousePointer = vbDefault
    
    If JmlFile > 0 Then
        Info.Caption = "Scanning Virus selesai! " & JmlFile & " Virus telah dihapus! Waktu Proses : " & DateDiff("s", t, Now) & " detik"
        MsgBox "Scanning Virus selesai! " & JmlFile & " Virus telah dihapus!" & vbCrLf & _
                JmlCuriga & " File dicurigai sebagai Virus, cek manual file yang bertanda [x]!"
    Else
        Info.Caption = "Scanning Virus selesai! Tidak ada Virus di " & DriveYgDicari & ". Waktu Proses : " & DateDiff("s", t, Now) & " detik"
        MsgBox "Scanning Virus selesai! Tidak ada Virus di " & DriveYgDicari & "." & vbCrLf & _
                JmlCuriga & " File dicurigai sebagai Virus, cek manual file yang bertanda [x]!"
    End If
